package cn.ifreehub.excel.internal.util;
...
public class Assert {
  ...
  public static void hasNoLength(String text, String message) {
    if (StringUtils.isNotEmpty(text)) {
      throw new IllegalArgumentException(message);
    }
  }

  public static void hasNolength(String text, String message, Object... additional) {
    if (StringUtils.isNotEmpty(text)) {
      throw new IllegalArgumentException(String.format(message, additional));
    }
  }
